...
public class student_signIn extends AppCompatActivity implements View.OnClickListener {
    //Initialize
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup = (TextView) findViewById(R.id.student_signup);
        signup.setOnClickListener(this);
        signin = (Button) findViewById(R.id.submit);
        signin.setOnClickListener(this);
        forgot = (TextView)findViewById(R.id.student_forgot);
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        if (user.isEmailVerified()){
                            // Redirect
                            startActivity(new Intent(student_signIn.this, Student_DashBorad.class));
                        }else {

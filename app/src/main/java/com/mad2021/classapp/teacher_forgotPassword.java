...
public class teacher_forgotPassword extends AppCompatActivity implements View.OnClickListener {
        ...
        mAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(teacher_forgotPassword.this,"Check your email to reset your password !",Toast.LENGTH_LONG).show();
                    startActivity(new Intent(teacher_forgotPassword.this,teacher_signin.class));
                }else {
                    Toast.makeText(teacher_forgotPassword.this,"Try again! Something wrong happened!",Toast.LENGTH_LONG).show();

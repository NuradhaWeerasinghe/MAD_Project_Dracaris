...
public class teacher_edit_view extends AppCompatActivity {
    // Declaring Variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_edit_view);
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(teacher_edit_view.this,"Something is wrong !!", Toast.LENGTH_LONG).show();
            }
        });
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Teachers").child(userID);
                ...
                Toast.makeText(teacher_edit_view.this,"Profile Updated ",Toast.LENGTH_SHORT).show();
                Intent i = new Intent(v.getContext(),teacher_Vvew_profile.class);
